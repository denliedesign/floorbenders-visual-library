...
<section {{ $attributes->class('fb-panel overflow-hidden') }}>
    ...
    <article class="m-5 p-5 rounded-3xl border border-amber-500/20 bg-amber-500/10 p-6">
        ...
        <div class="mt-6 overflow-hidden rounded-2xl border border-amber-500/20 bg-stone-950/80">
            <div class="grid grid-cols-[110px_repeat(6,minmax(0,1fr))] border-b border-amber-500/20 text-xs font-semibold uppercase tracking-[0.14em] text-amber-100/60">
            ...
            <div class="grid grid-cols-[110px_repeat(6,minmax(0,1fr))] border-b border-amber-500/10 text-sm">
            ...
            <div class="grid grid-cols-[110px_repeat(6,minmax(0,1fr))] text-sm">
